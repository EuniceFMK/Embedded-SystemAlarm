...
{//Offset from CCR1
    TimCCR1 = 0x00,   //0x34 -  Offset from Base Timer Addr    // CCR1 Combien de temps la sortie reste active sur le canal1
...
{
    OutputCompareToggle =0x3,
    InputCapture,
    Pwm1=0x6,       //Positive polarity
    Pwm2=0x7,       //NegativePolarity
}ChannelMode_Typedef;
